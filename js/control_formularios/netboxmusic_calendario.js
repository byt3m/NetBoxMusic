...
/***********************************************************************************
Nombre del fichero: netboxmusic_calendario.js
Descripción: fichero javascript usado para las funciones del calendario.
***********************************************************************************/

function inicializarCalendario(elemento) {
  new JsDatePick({
    useMode:2,
    target:elemento,
    dateFormat:"%d-%m-%Y",
...
g_l["DAYS_3"] = ["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"];
g_l["MONTH_FWD"] = "Mes siguiente";
g_l["MONTH_BCK"] = "Mes anterior";
g_l["YEAR_FWD"] = "Año siguiente";
g_l["YEAR_BCK"] = "Año anterior";
g_l["CLOSE"] = "Cerrar el calendario";
g_l["ERROR_2"] = g_l["ERROR_1"] = "¡Objeto no válido!";
g_l["ERROR_4"] = g_l["ERROR_3"] = "Selección incorrecta";
...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "img/calendario/";
