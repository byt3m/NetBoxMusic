<?php
/**********************************************************************************
Nombre del fichero: netboxmusic_buscar.php
...
<div id="buscador">
	...
	<input type="text" id="busqueda_fecha1" style="display: none;" placeholder="Inicio" onblur="inicializarCalendario('busqueda_fecha2');" maxlength="10" size="10"/>
	<input type="text" id="busqueda_fecha2" style="display: none;" placeholder="Fin" maxlength="10" size="10"/>
	<!---->
...
function buscar() {
	...
	var SelectTipoBusqueda = document.getElementById("tipo_busqueda");
    var ValorTipoBusqueda = SelectTipoBusqueda.options[SelectTipoBusqueda.selectedIndex].value;
	$.post("netboxmusic_buscar_post.php", { busqueda: texto, tipo_busqueda: ValorTipoBusqueda, fecha1: fechainicioReverse, fecha2: fechafinReverse } );
	setTimeout(function(){
		$.post("netboxmusic_buscar.php", function(data){$("#contenido").html(data);});		
	}, 500);	
}
...
<!-- MOSTRAMOS LOS RESULTADOS DE LA BÚSQUEDA (array) -->
<?php
