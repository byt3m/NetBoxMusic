<?php
/**********************************************************************************
Nombre del fichero: netboxmusic_generos_post.php
Descripción: recibe el id del género al que se quiere acceder
...
session_start();
//Metemos el id del género seleccionado en una variable de sesión.
$_SESSION["IdGenero"] = $_POST["id"];
?>